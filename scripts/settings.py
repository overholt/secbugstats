...
TEAMS = [["Layout",
          "Details.product='Core' AND (Details.component LIKE 'layout%' OR Details.component LIKE 'print%' OR Details.component LIKE 'widget%' OR Details.component IN ('CSS Parsing and Computation','Style System (CSS)','SVG','Internationalization','MathML','DOM: Animation','Editor','DOM:CSS Object Model'))"],
         ["Media",
         ...
         ["Security",
          "Details.product='Core' AND (Details.component IN ('DOM: Security','Security: CAPS','Security'))"],
         ["Other",
          "Details.product='Core' AND (Details.component IN ('DMD','File Handling','General','Geolocation','IPC','Java: OJI','jemalloc','js-ctypes','Memory Allocator','mfbt','mozglue','Permission Manager','Preferences: Backend','String','XPCOM','MFBT','Disability Access APIs','Rewriting and Analysis','RDF','Spelling checker','Web Services','XForms','DOM: Flyweb','DOM: Content Processes') OR Details.component LIKE 'Embedding%' OR Details.component LIKE '(HAL)' OR Details.component LIKE 'xp toolkit'"],
         ["DOM",
          "Details.product='Core' AND (Details.component LIKE 'DOM%' OR Details.component IN ('Document Navigation','Drag and Drop','Event Handling','HTML: Form Submission','HTML: Parser','Keyboard: Navigation','Selection','Serializers','XBL','XML','XPConnect','XSLT'))"],
         ["GFX",
         ...
         ["Frontend",
          "Details.product='Firefox' OR Details.product='Firefox for Metro' OR Details.product='Toolkit' OR (Details.product='Core' AND (Details.component IN ('Form Manager','History: Global','Identity','Installer: XPInstall Engine','Security: UI','Keyboard: Navigation','XUL')))"],
         ["Networking",
